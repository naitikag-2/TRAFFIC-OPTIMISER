...
function initRealLifeMap() {
  ...
  // Real-world intersection dataset with coordinates
  const junctions = [
    {
      id: 'sec-5',
  ...
  // Initialize Leaflet Map centered on Smart Mobility Corridor
  ...
  // Layer 1: CartoDB Positron (clean light street map)
  ...
  // Draw Real-world Arterial Traffic Corridors (Green Waves)
  const corridor1 = [
    [28.4595, 77.0266],
    [28.4700, 77.0350],
    [28.4800, 77.0500]
